...
#define MOTOR_1A_TRIS TRISAbits.TRISA0
...
#define MOTOR_1A_O LATAbits.LATA0
#define MOTOR_2A_O LATAbits.LATA1

#define MOTOR_1B_O LATBbits.LATB0
#define MOTOR_2B_O LATBbits.LATB1
